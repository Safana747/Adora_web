                        ...
                        <div class="body">
                            ...
                            <form id="basic-form" method="post" action="{{route('admin.teams_update',$result->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" maxlength="50" class="form-control" id="tname" name="name" value="{{$result->name}}">
                                </div>
                                <div class="form-group">
                                    <label>Designation</label>
                                    <input type="text" maxlength="50" class="form-control" id="designation" name="designation" value="{{$result->designation}}">
                                </div>
