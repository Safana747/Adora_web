                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($result as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{url('assets/images/brands/'.$item->image)}}" style="max-height: 100%;max-width: 100%;width: 100%;height: 100px;object-fit: contain">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="del_itm('{{route('admin.brands_delete',$item->id)}}')" href='javascript:void(0)' class='btn btn-danger btn-sm'
