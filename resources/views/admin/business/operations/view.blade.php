            ...
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <a href="{{route('admin.operations_add')}}" class="btn btn-primary btn-lg"><i class="fa fa-plus-square"></i> Add</a>
                    </div>
                </div>
            </div>
            @php
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($result as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{url('assets/images/operations/'.$item->image)}}" width="100" height="100">
                                        </td>

                                        <td >

                                            <form method="post" action="{{route('admin.operations_image_upload',$item->id)}}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="input-group col-md-12">
                                                    <div class="custom-file">
                                                        <input type="file" name="file" class="form-control">
                                            ...
                                            @foreach($m_image as $multi_image)
                                                <div class="col-lg-3">
                                                    <div class="card">
                                                        <div class="file">
                                                            <div class="hover">
                                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('admin.operations_image_delete',$multi_image->id)}}" class="btn btn-icon btn-danger">
                                                                    <i class="fa fa-trash"></i>
                                                                </a>
                                                            </div>
                                                            <div class="image">
                                                                <img src="{{url('assets/images/operations/'.$multi_image->image)}}" style="max-height: 100%;max-width: 100%;width: 100%;height: 100px;object-fit: cover" alt="img" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.operations_edit',$item->id)}}"
                                               class="btn btn-info btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a onclick="del_itm('{{route('admin.operations_delete',$item->id)}}')" href='javascript:void(0)' class='btn btn-danger btn-sm'
