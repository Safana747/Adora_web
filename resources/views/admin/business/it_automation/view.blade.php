            ...
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <a href="{{route('admin.it_automation_add')}}" class="btn btn-primary btn-lg"><i class="fa fa-plus-square"></i> Add</a>
                    </div>
                </div>
            </div>
                                ...
                                @foreach($result as $index => $item)
                                    <tr>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="card">
                                                        <div class="file">
                                                            ...
                                                            <div class="image">
                                                                <img src="{{url('assets/images/it_automation/'.$multi_image->image)}}"  style="max-height: 100%;max-width: 100%;width: 100%;height: 100px;object-fit: cover" alt="img" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.it_automation_edit',$item->id)}}"
                                               class="btn btn-info btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a onclick="del_itm('{{route('admin.it_automation_delete',$item->id)}}')" href='javascript:void(0)' class='btn btn-danger btn-sm'
