            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-8 col-sm-12">
                        ...
                        <hr/>
                        <a href="{{route('admin.consulting')}}" class="btn btn-dark  btn-sm"><i class="icon-action-undo"></i> Back</a>
                    </div>
                </div>
            </div>
            <hr/>
                ...
                <div class="col-md-8">
                    <div class="card" style="border-color:#2b2e33">
                        <div class="body">
                            ...
                            <form id="basic-form" method="post" action="{{route('admin.consulting_update',$result->id)}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><img id="blah1" width="100" src="{{url('assets/images/consulting/'.$result->image)}}" height="100"></td>
