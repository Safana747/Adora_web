                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            ...
                                            @foreach($m_image as $multi_image)
                                                <img width="100" height="100" src="{{url('assets/images/consulting/'.$multi_image->image)}}" alt="img" class="img-fluid">
                                        ...
                                        <td>
                                            ...
                                            <a onclick="del_itm('{{route('admin.consulting_delete',$item->id)}}')" href='javascript:void(0)' class='btn btn-danger'
