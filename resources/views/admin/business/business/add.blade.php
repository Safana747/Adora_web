                ...
                <div class="col-md-8">
                    <div class="card" style="border-color:#2b2e33">
                        ...
                        <div class="body">
                            ...
                            <form id="basic-form" method="post" action="{{route('admin.business_save')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="business" class="custom-select" name="bus_type">
                                        @if(!(DB::table('business')->where('bus_type', 'it_automation')->first()))
                                            <option value="it_automation" >It Automation </option>
                                        @endif
                                        @if(!(DB::table('business')->where('bus_type', 'consulting')->first()))
                                            <option value="consulting">Consulting </option>
                                        @endif
                                        @if(!(DB::table('business')->where('bus_type', 'contracting')->first()))
                                            <option value="contracting">Contracting </option>
                                        @endif
                                        @if(!(DB::table('business')->where('bus_type', 'trading')->first()))
                                            <option value="trading">Trading </option>
                                        @endif
                                        @if(!(DB::table('business')->where('bus_type', 'operations')->first()))
