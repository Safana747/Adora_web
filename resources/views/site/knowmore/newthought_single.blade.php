@extends('layouts.app')
@section('content')
@section('title', 'Adora Group | New Thoughts')
@push('styles')
@endpush
        ...
        <div class="container text-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">New Thoughts</li>
                </ol>
            </nav>
        </div>
    </section>
    <section class="single_list">
        <div class="container">
            <div class="row main_content">
                ...
                <div class="col-md-6">
                    <img src="{{url('assets/images/newthoughts/'.$landing_first->image)}}" class="img-fluid">
                </div>
            </div>
            ...
            <div class="row images_list mt-5 justify-content-center">
                ...
                {{--@foreach($newthoughts as $index=>$item)--}}

                    <div class="col-md-12">
                        <img src="{{url('assets/images/newthoughts/'.$landing_first->image)}}" class="img-fluid img-object-cover">
                    </div>
