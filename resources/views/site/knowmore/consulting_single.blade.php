    ...
    <section class="single_list">
        <div class="container">
            <div class="row main_content">
                ...
                <div class="col-md-6">
                    <img src="{{url('assets/images/consulting/'.$landing_first->image)}}" class="img-fluid">
                </div>
            </div>
            ...
            <div class="row images_list mt-5 justify-content-center">
                ...
                {{--@foreach($consulting as $index=>$item)--}}

                    <div class="col-md-12">
                        <img src="{{url('assets/images/consulting/'.$landing_first->image)}}" class="img-fluid img-object-cover">
                    </div>
