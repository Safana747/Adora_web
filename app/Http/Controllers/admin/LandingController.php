...
class LandingController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['count'] = DB::table('landing')->count();
        $data['result'] = DB::table('landing')->orderBy('id','desc')->paginate(25);
        return view('admin.landing.view', $data);
    }
    ...
    public function add()
    {
        ...
        return view('admin.landing.add',$data);
    }
    ...
    public function save(Request $request)
    {
        ...
        function slugify($text)
        {
            ...
            if (empty($text))
            {return 'n-a';}
            $checkUrl = DB::table('landing')->where('seo_url', $text)->count();
            if($checkUrl==0)
        ...
        DB::table('landing')->insert($data);
        return redirect('admin/home')->with("view_msg", "<div class='alert alert-success'>Successfully saved!</div>");
    ...
    public function edit($id)
    {
        ...
        $data['result']=DB::table('landing')->where('id', '=', $id)->first();
    ...
    {
        $item=DB::table('landing')->where('id', '=', $id)->first();
        ...
        if($item)
        {
            ...
            DB::table('landing')->where('id',$id)->update($data);
            return redirect('admin/home')->with("view_msg", "<div class='alert alert-success'>Successfully updated</div>");
    ...
    public function delete($id)
    {
        ...
        if($item)
        {
            //---------------------------------------------
            $table_name='landing';
            $image_path=public_path('assets/images/homeslider/');
            //-----------------------------------------------------
            ...
            DB::table('landing')->where('id',$id)->delete();
            return redirect('admin/home')->with("view_msg", "<div class='alert alert-success'>Successfully Deleted!</div>");
        }
        else
        {
            return redirect('admin/home');
    ...
    public function uploadImg(Request $request, $ser_id = null)
    {
        ...
        $upload_path = '/assets/images/homeslider/';
        $rules = array(
...
//-------------------------------------------------------------
    ...
    {
        $success_url = 'admin/home';
        $delete_path = 'assets/images/homeslider/';
        if (!$id == null) {
            //--------------START---------------------------------
