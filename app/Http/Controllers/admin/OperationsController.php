...
class OperationsController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        if($item)
        {
            ...
            $image_path=public_path('assets/images/operations/');
            //-----------------------------------------------------
    ...
    {
        $table_name = 'operations';
        $success_url = 'admin/business/operations';
        $upload_path = '/assets/images/operations/';
        $rules = array(
...
//-------------------------------------------------------------
    ...
    {
        $success_url = 'admin/business/operations';
        $delete_path = 'assets/images/operations/';
        if (!$id == null) {
            //--------------START---------------------------------
